...
(function() {
  var DiffHandler, Server, StorageController, commands, diffModulesCount, getDiffs, getDir, getDirs, getFile, getGuitarDiff, hasCommand, initCommands, moduleTypes, pushDiff, pushModel, server, serverEvents, setModuleType;
  ...
  server.broadcastDiffModules = function(data) {
    var client, i, len, ref, ref1, results;
    ref = server.clients;
    results = [];
    for (i = 0, len = ref.length; i < len; i++) {
      client = ref[i];
      if ((ref1 = client.type) === 'documentation' || ref1 === 'code' || ref1 === 'fat model code') {
